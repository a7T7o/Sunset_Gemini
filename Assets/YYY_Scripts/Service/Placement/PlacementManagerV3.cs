...
public class PlacementManagerV3 : MonoBehaviour
{
    ...
    public static PlacementManagerV3 Instance { get; private set; }
    ...
    [Header("━━━━ 组件引用 ━━━━")]
    [SerializeField] private PlacementPreviewV3 placementPreview;
    ...
    private PlacementValidatorV3 validator;
    ...
    private List<CellStateV3> currentCellStates = new List<CellStateV3>();
    ...
    private void Awake()
    {
        ...
        // 初始化验证器
        validator = new PlacementValidatorV3();
    ...
    private void Start()
    {
        ...
        if (playerTransform == null)
        {
            ...
            {
                Debug.LogError("[PlacementManagerV3] 未找到 Player 标签的物体！");
            }
        }
        ...
        {
            GameObject previewObj = new GameObject("PlacementPreviewV3");
            previewObj.transform.SetParent(transform);
            placementPreview = previewObj.AddComponent<PlacementPreviewV3>();
        }
